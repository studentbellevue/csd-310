"""whatabook.py: application for whatabook users"""
___author___ = "Devon Lohrmann with assistance from Professor Haas's GitHub example"
...
def show_menu():
    ...
    try:
        choice = int(input('      <Example numeric choice:  '))
        return choice
